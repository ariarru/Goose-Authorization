            ...
            JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, url + fingerprintUrl, jsonBody,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                boolean author = response.getBoolean("author");  // Controlla il valore di "author"
                                if (author) {
                                    // Se l'utente è autorizzato, continua con la logica attuale
                                    ...
                                    // Se non è autorizzato, invia una notifica
                                    backgroundService.sendBasicNotification("Unauthorized Access", "You are not authorized to stay in the predicted room.");
                                    Log.e("GOOSE CHECK", "Utente non autorizzato nella stanza.");
                                }
                            } catch (JSONException e) {
                                Log.e("GOOSE REQUEST", "cannot find predicted room value", e);
